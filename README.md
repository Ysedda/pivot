...
- [`phases/0X-<phase>/lessons.md`](phases/) — running log per phase, colocated with each phase's plan and evals. What surprised me, what bit me. The single most interview-relevant artifact in this repo. See [`phases/README.md`](phases/README.md) for format guide; see [`tasks/tips.md`](tasks/tips.md) § Resources for reading lists.
